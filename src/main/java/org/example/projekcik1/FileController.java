...
public class FileController {
    ...
    public ResponseEntity<String> uploadFilePoprawnie(@RequestParam("file") MultipartFile file) {
        try {
            var nwCoToZwraca = fileProcessor.newFile(file); // metody serwisów mogą rzucac błedami, kontrolery powinny je ewentualnie tylko łapać
